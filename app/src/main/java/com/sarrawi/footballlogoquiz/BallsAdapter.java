...
public class BallsAdapter extends BaseAdapter {
	...
	public BallsAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
		context = a;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View vi = convertView;
		if (convertView == null)
			vi = inflater.inflate(R.layout.ball_row_grid, null);
		
		TextView letterBall = (TextView) vi.findViewById(R.id.letterBall); // flag

		HashMap<String, String> ballMap = new HashMap<String, String>();
		ballMap = data.get(position);

		letterBall.setText(ballMap.get(GameActivity.KEY_BALL).toUpperCase());
...
//					+ letter.get(LogoActivity.KEY_LETTER).toUpperCase() + ".png");
//		} catch (IOException e) {
